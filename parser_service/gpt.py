...
prompts = (
    ...
    '3. Ты должен использовать теги такие как <b></b> или <i></i> вместо **, это обязательно!, для отметки интересных моментов. Используй только теги <b>, <i>, <code>, <pre>, <span class="tg-spoiler">, <s>, <a href="url"> другие теги использовать ЗАПРЕЩЕНО. Не используй <li>, <h2>, <p>, <ul>, <br>'
